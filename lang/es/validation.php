...
return [
    ...
    'password' => [
        ...
        'symbols' => 'La :attribute debe contener al menos un símbolo (por ejemplo: @, #, $, %, etc.).',
        'uncompromised' => 'La :attribute ha aparecido en una filtración de datos. Por favor elige una :attribute diferente.',
    ],
